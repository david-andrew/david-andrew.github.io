image_paths = {
    ...
    'escort_mission': '../(images)/projects/escort_mission_lamb.png',
    'dewy_dandelion': '../(images)/projects/dewy_dandelion.jpg',
    'boat_simulator': '../(images)/projects/boat_simulator.jpg',
    'rewind_title': '../(images)/projects/rewind_title.png',
    'blob_opera_nox': '../(images)/projects/blob_opera_nox.png',
    'prs2019_preview': '../(images)/projects/prs2019_preview.png',
    'foxing_animatronic': '../(images)/projects/foxing_animatronic.png',
    'rebel_scum': '../(images)/projects/rebel_scum.jpg',
    'music_staff': '../(images)/projects/music_staff.png',
    'ye_arlington_musicke_lab_logo': '../(images)/projects/YeArlingtonMusickeLabLogo.png',
    'wse18': '../(images)/projects/wse18.png',
    'mona_lisa_contour': '../(images)/drawbot/mona_lisa_contour.jpg',
    'timelapse': '../(images)/projects/timelapse.jpg',
    'terminal_ray_tracer': '../(images)/projects/terminal_ray_tracer.png',
}
...
for project in projects:
    print(project['title'])
    folder = f"./app{project['internalLink']}"
...
import {project['imgSrc']} from '../{image_paths[project['imgSrc']]}'

export const meta: ProjectMeta = {{
    title: '{project['title']}',
    imgSrc: {project['imgSrc']},
    {f"github: '{project['github']}'," if 'github' in project else ''}
    {f"internalLink: '{project['internalLink']}'," if 'internalLink' in project else ''}
    {f"externalLink: '{project['externalLink']}'," if 'externalLink' in project else ''}
    summary: '{project['summary']}',
    {f"lastUpdated: '{project['lastUpdated']}'," if 'lastUpdated' in project else ''}
    {f"tags: {project['tags']}," if 'tags' in project else ''}
}};
