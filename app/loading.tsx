...
const Loading = ({ size = 'large' }: LoadingProps): JSX.Element => {
    ...
    return (
        <div className="fixed w-screen h-screen bg-black flex justify-center items-center">
            <div role="status">
                <svg aria-hidden="true" className={`${spinnerSizeClass} mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-accent`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
