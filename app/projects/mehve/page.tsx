    ...
    return (
        <>
            ...
            <P>
                ...
                in this <Link href="https://www.youtube.com/c/K%C3%A1rolyZsolnai">Two Minute Papers</Link> video:
            </P>
            ...
            <P>
                ...
                <Link href="https://en.wikipedia.org/wiki/L-system">L-systems</Link> where different varieties of plants are procedurally
