...
const Page = async (): Promise<JSX.Element> => {
    ...
    return (
        <>
            ...
            <P>
                <Link className="text-3xl font-quadon" href="https://dsamson.itch.io/silver-void">
                    Play/Download on Itch.io
                </Link>
            </P>
            <P>
                Silver Void was my <Link href="https://itch.io/jam/acerola-jam-0/rate/2557875">submission</Link> to{' '}
                <Link href="https://itch.io/jam/acerola-jam-0">Acerola Jam 0</Link>. Participants had 2 weeks to solo
                create a game on the theme &quot;Aberration&quot;, as in a departure from what is normal, usual, or
                expected. Initially I wanted to make a time loop game, sort of like Groundhog Day or Re:Zero, but
                quickly determined that even with 2 weeks, the scope was too large. So I settled on making a realistic
                3D space simulator, where the player takes part in a fleet battle. This fits the theme in that the
                enemies continually predict where the player will be based on current position and velocity, and so the
                player needs to continually thrust and change trajectories (i.e. make an aberration from their current
            ...
            <H3>Soundtrack</H3>
            <P>
                I didn&apos;t have a lot of time to work on the soundtrack, so it&apos;s just a single take. But
                apparently people enjoyed it a lot, so here it is:
            </P>
            <YouTube videoId="0t_NKVzPSF8" />
            <H3>Cut Features</H3>
            <P>
            ...
            <IconBulletList>
                <IconBullet icon="chrome">
                    <Link href="https://dsamson.itch.io/silver-void">Web Version</Link>
                </IconBullet>
                <IconBullet icon="linux">
                    <Link href="https://github.com/david-andrew/SilverVoid/releases/download/0.1.7/linux_0.1.7.zip">
                        Download linux_0.1.7
                    </Link>
                </IconBullet>
                <IconBullet icon="windows">
                    <Link href="https://github.com/david-andrew/SilverVoid/releases/download/0.1.7/windows_0.1.7.zip">
                        Download windows_0.1.7
                    </Link>
                </IconBullet>
                <IconBullet icon="apple">
                    <Link href="https://github.com/david-andrew/SilverVoid/releases/download/0.1.7/mac_0.1.7.zip">
                        Download mac_0.1.7
                    </Link>
                </IconBullet>
                {/* </IconBulletList>
            ...
            <IconBulletList> */}
                <IconBullet icon="github">
                    <Link href="https://github.com/david-andrew/SilverVoid">Source Code</Link>
                </IconBullet>
            </IconBulletList>
        </>
    )
