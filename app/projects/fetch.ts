...
export const getImages = async (route: string): Promise<StaticImageData[]> => {
    ...
    const imagePromises = images.map(async (image): Promise<StaticImageData | undefined> => {
