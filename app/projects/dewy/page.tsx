...
const Page = (): JSX.Element => {
    return (
        <>
            ...
            <H3>About</H3>
            <P>
                Dewy is a programming language I have been developing off and on since 2016. The main goal is to build a language with all the features
                I&apos;ve always wished existed in a single language. Dewy is a general purpose language with a focus on scientific and engineering applications. At a
...
`}
            ...
            <CodeBlock
                // flatten
                code={
`word_bools = [[true false false true false false true false ...]
...
`}
            />
            <P>
                Currently, I am learning LLVM, in order to build a compiler back-end to connect with the
