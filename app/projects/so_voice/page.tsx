...
const Page = (): JSX.Element => {
    return (
        <>
            <P>
                so voice! is the spiritual successor to my <Link href="/projects/musical_dl">Deep Learning Capstone Project</Link>. The goal
            ...
            <P>
                ...
                rates, small pitch range, etc. More recently a <Link href="https://magenta.tensorflow.org/ddsp">article/paper</Link> by
            ...
            />
            <P>
                Additionally, using the music parsing engine, I put together a <Link href="/projects/blob_opera">silly spinoff project</Link>{' '}
                leveraging Google Arts &amp; Culture&apos;s{' '}
                <Link href="https://artsandculture.google.com/experiment/blob-opera/AAHWrq360NcGbw">Blob Opera</Link> as a stand in for
                choir synthesis.
            </P>
            ...
            <P>
                ...
                <Link href="https://ccrma.stanford.edu/~hskim08/lpc/">Linear Predictive Coding</Link> technique to splice them together at
