...
type match_fn = (s:string) => Token|Token[]|undefined;
...
const parse_dewy_meta_lang = (code: string): Token[] => {
    ...
    while (index < code.length) {
        ...
        if (token) {
            ...
            tokens.push({type: "meta", start: index, end: index+1});
            index++;
        }
    }
...
export const dewy_meta_theme = createTheme({
    ...
    styles: [
        ...
        { tag: t.literal, color: '#ce9178' },
        { tag: t.bracket, color: '#179fff' },
