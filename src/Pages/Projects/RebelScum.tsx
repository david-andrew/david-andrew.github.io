...
export const RebelScum = (): JSX.Element => {
        ...
        <>
            <PageContainer>
                ...
                <p>
                    ...
                    <ul>
                        <li>replace engine mount with custom structure designed for a larger class J motor</li>
                        <li>add an arduino based avionics system for detecting altitude and activating the main chute</li>
                        <li>replace the old fins with twice as many to ensure stability</li>
                        <li>add a new coat of paint and decals</li>
                    </ul>
