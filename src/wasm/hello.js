...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_func')) {
        Object.defineProperty(Module['ready'], '_func', { configurable: true, get: function() { abort('You are getting _func on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_func', { configurable: true, set: function() { abort('You are setting _func on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_func2')) {
        Object.defineProperty(Module['ready'], '_func2', { configurable: true, get: function() { abort('You are getting _func2 on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_func2', { configurable: true, set: function() { abort('You are setting _func2 on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_segfault')) {
        Object.defineProperty(Module['ready'], '_segfault', { configurable: true, get: function() { abort('You are getting _segfault on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_segfault', { configurable: true, set: function() { abort('You are setting _segfault on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
if (Module['locateFile']) {
  ...
  var wasmBinaryFile = new URL('hello.wasm', import.meta.url).toString();
}
...
/** @type {function(...*):?} */
var _func2 = Module["_func2"] = createExportWrapper("func2");

/** @type {function(...*):?} */
var _segfault = Module["_segfault"] = createExportWrapper("segfault");
